...
import org.mule.extension.coupa.internal.metadata.MarkExportedObjectKeysResolver;
...
public class MarkExportedObjectKeysResolverTest {

    @Test
    public void testGetKeys() throws Exception {
        MarkExportedObjectKeysResolver resolver = new MarkExportedObjectKeysResolver();
        Set<MetadataKey> set = resolver.getKeys(null);
        assertNotNull(set);

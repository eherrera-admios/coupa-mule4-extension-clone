...
public class InventoryTransactions extends BasicApi {

    private static final String INVENTORY_TRANSACTIONS = "inventory_transactions";

    public InventoryTransactions(CoupaConnection coupaConnection) {

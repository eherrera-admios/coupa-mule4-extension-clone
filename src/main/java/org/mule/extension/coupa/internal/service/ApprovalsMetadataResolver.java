...
import static org.mule.extension.coupa.internal.utils.Constants.APPROVAL_KEY;

public class ApprovalsMetadataResolver implements OutputTypeResolver<String> {
    ...
    public MetadataType getOutputType(MetadataContext context, String key) throws MetadataResolvingException, ConnectionException {
        ...
        String customFields = conf.getCustomFieldsStringByKey(APPROVAL_KEY);
        return CoupaMetadataResolver.generateMetaData(APPROVAL_KEY, customFields, false);

...
public class InvoicesMetadataResolver implements OutputTypeResolver<String> {
    ...
    public MetadataType getOutputType(MetadataContext context, String key) throws MetadataResolvingException, ConnectionException {
        ...
        String customFields = conf.getCustomFieldsStringByKey(INVOICE_KEY);
        return CoupaMetadataResolver.generateMetaData(INVOICE_KEY, customFields, false);
    }

...
public class ExpenseReports extends BasicApi {

    private static final String EXPENSE_REPORTS_PATH = "expense_reports";

    public ExpenseReports(CoupaConnection coupaConnection) {
        super(coupaConnection);
    }

    @Override
    String getPath() {
        return EXPENSE_REPORTS_PATH;
    }

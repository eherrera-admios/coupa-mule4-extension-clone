...
import static org.mule.extension.coupa.internal.utils.Constants.PURCHASE_ORDER_KEY;

public class PurchaseOrdersMetadataResolver implements OutputTypeResolver<String> {

    @Override
    public String getCategoryName() {
        return "purchase-order-actions";
    }
    @Override
    public MetadataType getOutputType(MetadataContext context, String key) throws MetadataResolvingException, ConnectionException {
        ...
        String customFields = conf.getCustomFieldsStringByKey(PURCHASE_ORDER_KEY);
        return CoupaMetadataResolver.generateMetaData(PURCHASE_ORDER_KEY, customFields, false);
    }

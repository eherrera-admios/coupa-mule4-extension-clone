...
public class InvoiceImageMetadataResolver implements OutputTypeResolver<String> {

    @Override
    public String getCategoryName() {
        return "invoices-image";
    }
    ...
    public MetadataType getOutputType(MetadataContext context, String key) throws MetadataResolvingException, ConnectionException {
        return BaseTypeBuilder.create(MetadataFormat.JAVA).binaryType().id("image").build();
    }

...
public class PurchaseOrders extends BasicApi {

    private static final String PURCHASE_ORDERS_PATH = "purchase_orders";

    public PurchaseOrders(CoupaConnection coupaConnection) {
        super(coupaConnection);
    }

    @Override
    String getPath() {
        return PURCHASE_ORDERS_PATH;
    }

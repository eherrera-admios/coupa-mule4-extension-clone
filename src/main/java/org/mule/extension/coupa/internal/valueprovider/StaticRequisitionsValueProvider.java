...
public class StaticRequisitionsValueProvider implements ValueProvider {

    @Override
    public Set<Value> resolve() throws ValueResolvingException {
        Map<String, String> valueMapRequisitions = new HashMap<>();
        valueMapRequisitions.put(REQUISITION_CART_KEY, REQUISITION_CART);
        valueMapRequisitions.put(REQUISITION_APPROVAL_KEY, REQUISITION_APPROVAL);
        return ValueBuilder.getValuesFor(valueMapRequisitions);
    }
}

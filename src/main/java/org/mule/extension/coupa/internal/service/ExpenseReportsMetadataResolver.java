...
import static org.mule.extension.coupa.internal.utils.Constants.EXPENSE_REPORT_KEY;

public class ExpenseReportsMetadataResolver implements OutputTypeResolver<String> {

    @Override
    public String getCategoryName() {
        return "expense-report-actions";
    }
    ...
    public MetadataType getOutputType(MetadataContext context, String key) throws MetadataResolvingException, ConnectionException {
        ...
        String customFields = conf.getCustomFieldsStringByKey(EXPENSE_REPORT_KEY);
        return CoupaMetadataResolver.generateMetaData(EXPENSE_REPORT_KEY, customFields, false);

...
public class GetRemitToAddressMetadata implements InputTypeResolver<String>, OutputTypeResolver<String> {
    ...
    public MetadataType getOutputType(MetadataContext metadataContext, String s) throws MetadataResolvingException, ConnectionException {
        return CoupaMetadataResolver.generateMetaData(REMIT_TO_ADDRESS_KEY, null, false);
    }
